...
const BankProfileScreen = ({ navigation }: ProfileProps) => {
  ...
  const profileData = {
    name: 'Centre de Transfusion Yaoundé',
    email: 'contact@transfusion-yde.cm',
    phone: '+237 677 234 567',
    location: 'Boulevard du 20 Mai, Yaoundé',
    license: 'BTS-2015-089',
    capacity: '500 unités',
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoItem}>
            ...
            <Text style={styles.infoText}>{profileData.license}</Text>
          </View>
          <View style={styles.infoItem}>
            <View style={styles.infoIcon}>
              <Text style={styles.icon}>📦</Text>
            </View>
            <Text style={styles.infoText}>{profileData.capacity}</Text>
          </View>
        </View>
        <View style={styles.card}>
